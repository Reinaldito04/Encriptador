...
btnCopiar.addEventListener("click",function(){        
  let Copiado = document.querySelector("#escriptado").value;
  navigator.clipboard.writeText(Copiado);
  document.querySelector("#escriptar").value="";
...
btnDesencriptar.addEventListener("click", function(){
  let textoIngresado = document.querySelector("#escriptar").value;
